...
const MainComponent = () => {
  ...
  const staticElementFetch = async (artistName, setSection) => {
    try {
  ...
  useEffect(() => {
    staticElementFetch("metallica", setRockSection);
    staticElementFetch("sia", setPopSection);
    staticElementFetch("eminem", setHipHopSection);
  }, []);
          ...
          <div className="col-10">
            <div id="searchResults">
              ...
              <div className="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 imgLinks py-3">
                {artistData.slice(0, 9).map((songInfo, i) => (
